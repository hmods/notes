...
Note, however, that having a uniform prior is not the same as having *no* prior.

Consequently, most Bayesian statisticians nowadays advocate for the inclusion of prior distributions that provide a better representation of "reasonable" values of our parameter rather than prior distributions that feign ignorance. 
