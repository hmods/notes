...
Some Bayesian statisticians nowadays advocate for the inclusion of reasonable prior distributions rather than prior distributions that feign ignorance. 
...
Last, we mention that we can calculate the posterior distribution of any derived parameters immediately from the simulated posterior draws. 
