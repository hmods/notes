...
If you have been out of high school or practice for a while and don't remember how to do matrix multiplication, it's worth investing some effort so that you can understand why $X\beta$ is such a powerful construct and there are a lot of good resources online to check out. 
...
If we used a p-value cutoff of 0.05 than we can be more specific and say that the observed (or more extreme) data would occur in less than 5% of the hypothetical infinite collection of experiments. 
...
Of course, if our data had been less extreme, such the calculated p-value for the interaction was now 0.06 (or 0.11), our frequentist statistician would say there is insufficient evidence for an interaction and that we should not use it to predict tooth length in the future.
