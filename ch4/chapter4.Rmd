...
```{r, message=FALSE, fig.cap="Sample mean and variances for abundance on Barro Colorado Island, with each point representing a different species."}
library(vegan)
library(dplyr)
data(BCI)
...
```{r, fig.cap="Posterior predictive check for the variance of plot abundance from the single species Poisson glm."}
post <- rstan::extract(out)
